...
const DEMO_KEYWORDS: KeywordCAC[] = [
  { keyword: 'crm software for startups', campaign: 'Brand — CRM', spend_monthly: 4200, deal_count: 6, total_deal_value: 57600, cac: 700, action: 'scale', source_type: 'keyword', pipeline_leads: 3 },
  { keyword: 'hubspot alternative b2b', campaign: 'Competitor — CRM', spend_monthly: 3100, deal_count: 4, total_deal_value: 38400, cac: 775, action: 'scale', source_type: 'keyword', pipeline_leads: 2 },
  { keyword: 'sales pipeline software', campaign: 'Generic — Pipeline', spend_monthly: 2800, deal_count: 2, total_deal_value: 19200, cac: 1400, action: 'monitor', source_type: 'keyword', pipeline_leads: 1 },
  { keyword: 'best crm 2026', campaign: 'Generic — CRM', spend_monthly: 1900, deal_count: 1, total_deal_value: 9600, cac: 1900, action: 'monitor', source_type: 'keyword', pipeline_leads: 0 },
  { keyword: 'crm free trial', campaign: 'Brand — CRM', spend_monthly: 3400, deal_count: 0, total_deal_value: 0, cac: null, action: 'cut', source_type: 'keyword', pipeline_leads: 0 },
  { keyword: 'customer management tool', campaign: 'Generic — CRM', spend_monthly: 2600, deal_count: 0, total_deal_value: 0, cac: null, action: 'cut', source_type: 'keyword', pipeline_leads: 0 },
  { keyword: 'salesforce vs hubspot', campaign: 'Competitor — CRM', spend_monthly: 1800, deal_count: 0, total_deal_value: 0, cac: null, action: 'cut', source_type: 'keyword', pipeline_leads: 0 },
  { keyword: 'crm pricing comparison', campaign: 'Generic — CRM', spend_monthly: 1500, deal_count: 0, total_deal_value: 0, cac: null, action: 'cut', source_type: 'keyword', pipeline_leads: 0 },
]
